...
const ContactForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent flex items-center justify-center px-6 py-12">
      ...
      >
        {/* ...existing code for header and form... */}
        <div className="text-center">
          ...
          <motion.h2
            ...
            className="text-4xl font-bold text-white bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600"
          >
            Let&#39;s Connect
          </motion.h2>
          <motion.p
        ...
        >
          {/* ...existing code for inputs and button... */}
