...
const SkillCard = memo<SkillCardProps>(function SkillCard({ skill, onClick }) {
      ...
      <div className="flex items-center mb-4">
        ...
        <Image
          ...
          onError={(e) => {
            ...
            target.src = 'https://img.icons8.com/ios/50/code--v1.png';
          }}
        />
        </div>
        <div>
...
const SkillDetailModal = memo<SkillDetailModalProps>(function SkillDetailModal({ skill, onClose }) {
...
const Skills: React.FC = () => {
  ...
  const handleSkillClick = useMemo(() => (skill: Skill) => setSelectedSkill(skill), []);
