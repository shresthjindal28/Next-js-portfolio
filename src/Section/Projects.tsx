...
const projects: ProjectType[] = [
  ...
  },
  {
    ...
    image: "/images/blogging-website.jpg",
  ...
  },
  {
    ...
    image: "/images/text-to-image.jpg",
  ...
  },
  {
    ...
    image: "/images/gradient-library.jpg",
  ...
  return (
    <div
      ...
      ref={(el) => {
        ...
        if (el) projectsRef.current[originalIndex] = el as HTMLElement;
      }}
